...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><meta name="description" content="Los parrots club"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/loroico.png"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderHead()}</head> <body> ${renderSlot($$result, $$slots["default"])} </body></html>`;
...
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Navbar;
  return renderTemplate`${maybeRenderHead()}<nav class="cursor-example flex flex-wrap items-center justify-between fixed inset-x-0 z-50 p-3 bg-black bg-opacity-60"> <a href="#" title="logoico"><img src="/loroico.png" class="h-10 w-10" alt="ACME" width="120" class=""></a> <div class="flex md:hidden"> <button id="hamburger" aria-label="menu" class="bg-[#e3d779] rounded-lg"> <img class="toggle block" src="https://img.icons8.com/fluent-systems-regular/2x/menu-squared-2.png" alt="" width="40" height="40"> <img class="toggle hidden" alt="" src="https://img.icons8.com/fluent-systems-regular/2x/close-window.png" width="40" height="40"> </button> </div> <div class="toggle hidden gap-5 w-full ml-4 md:w-auto md:flex text-center text-bold mt-5 md:mt-0"> <a title="navbar" href="#quienes" class="block md:inline-block text-xl text-[#e3d779] hover:text-yellow-500 px-3 py-3">Quiénes somos
</a> <a title="navbar" href="#repertorio" class="block md:inline-block text-xl text-[#e3d779] hover:text-yellow-500 px-3 py-3">Qué hacemos
</a> <a title="navbar" href="#clientes" class="block md:inline-block text-xl text-[#e3d779] hover:text-yellow-500 px-3 py-3">Qué dicen
</a> </div> <a title="navbar" href="#contacto" class="toggle hidden md:flex w-full text-xl md:w-auto px-4 py-2 font-bold text-center transition-all duration-200 bg-[#e3d779] hover:bg-yellow-700 hover:text-white text-black md:rounded">¡CONTÁCTANOS!
</a> </nav> `;
...
</p> <div class="flex justify-center items-center" data-astro-cid-g7hbrj26> <div class="relative inline-flex group" data-astro-cid-g7hbrj26> <div class="absolute transitiona-all duration-1000 opacity-70 -inset-px bg-gradient-to-r from-[#aca259] via-[#aca259] to-[#aca259] rounded-xl blur-lg group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200 animate-tilt" data-astro-cid-g7hbrj26></div> <a href="#contacto" title="Contacto" class="relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-[#aca259] font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900" role="button" data-astro-cid-g7hbrj26>Quiero contactaros
</a> </div> </div> </div> <div class="lg:w-1/2 lg:ml-12" data-astro-cid-g7hbrj26> <iframe title="musica" class="md:w-96 h-80 w-96 md:h-96" style="border-radius:12px" src="https://open.spotify.com/embed/playlist/3s1M8yXQEVPlUbwHRMIeZh" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy" data-astro-cid-g7hbrj26></iframe> </div> </div> </div> </div> `;
    ...
    <div class="sm:text-center lg:text-left">
      ...
      <div class="mt-3 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
        <div class="rounded-md shadow">
          <a 
          title="bodas"
          href="https://www.bodas.net/musica/parrots--e179028"
  ...
  <div class="  mySwiper ml-6  md:ml-10 h-96 w-80 md:w-96 ">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="/op2.JPG" alt="opinion" class="" />

      </div>
      <div class="swiper-slide"> <img src="/op1.JPG" alt="opinion"  class="" />
      </div>
      <div class="swiper-slide"> <img src="/op3.JPG"  alt="opinion" class="" />
      </div>
      <div class="swiper-slide"> <img src="/op4.JPG" alt="opinion"  class="" />
      </div>
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<div class="mt-2 text-center"> <a href="#" class="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900"> <img src="/loroico.png" class="h-12 mr-3 sm:h-9" alt="Landwind Logo"> </a> <span class="block text-md text-center text-gray-200">© 2024 Parrots Club. Todos los derechos reservados. Hecha en
<a title="Astro" href="https://astro.build/" class="text-orange-500 hover:underline">Astro</a> por
<a title="pavelsoft" href="https://www.linkedin.com/company/pavel-soft" class="text-white hover:underline "><span class="text-sky-400">P</span>a<span class="text-lime-400">V</span>el Soft.
</a>.
</span> </div>`;
