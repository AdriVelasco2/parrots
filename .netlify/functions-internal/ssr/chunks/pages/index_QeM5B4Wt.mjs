...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/loroico.png"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderHead()}</head> <body> ${renderSlot($$result, $$slots["default"])} </body></html>`;
...
const $$Hero = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Hero;
  return renderTemplate`<!-- forked from: https://codepen.io/cuonoj/pen/JjPmMaB -->${maybeRenderHead()}<section class="relative h-screen flex flex-col items-center justify-center text-center text-white" data-astro-cid-bbe6dxrz> <div class="video-docker absolute top-0 left-0 w-full h-full overflow-hidden" data-astro-cid-bbe6dxrz> <video class="min-w-full min-h-full absolute object-cover" src="/parrotshero2.mp4" autoplay muted loop data-astro-cid-bbe6dxrz></video> </div> <div class="video-content space-y-2 z-10" data-astro-cid-bbe6dxrz> <img class="" src="/logo.png" data-astro-cid-bbe6dxrz> </div> </section> `;
